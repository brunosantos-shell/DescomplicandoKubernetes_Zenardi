...
- [Descomplicando o Kubernetes](#descomplicando-o-kubernetes)
  ...
  - [Conteúdo do Day-10](#conteúdo-do-day-10)
    ...
    - [Conteúdo do Day-10](#conteúdo-do-day-10-1)
...
- [O que são os Annotations e as Labels no Kubernetes?](#o-que-são-os-annotations-e-as-labels-no-kubernetes)
  ...
  - [Limitando requisições das nossas aplicações com o Ingress](#limitando-requisições-das-nossas-aplicações-com-o-ingress)
